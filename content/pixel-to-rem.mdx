...
tags: ['posts', 'scss']
summary: Pixel degerlerini rem degerlerine çevirme (px to rem)
---

![Sass Logo](/images/sass-logo.png 'Sass Logo')
...
![Pikselleri rem tipine çeviren fonksiyon](/images/px-to-rem.png 'Pikselleri rem tipine çeviren fonksiyon')
