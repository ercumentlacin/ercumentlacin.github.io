    ...
    <article className="prose mx-auto">
      ...
      <section>
        ...
        <p>
          ...
          I&apos;ve been interested in frontend development since my high school
          years, and I&apos;ve been professionally involved in this field for
          the past 4 years.
        </p>
      </section>
      <section>
      ...
      <section>
        ...
        <p>
          I thoroughly enjoy working on UI development. Adding new features and
          seeing them come to life in a live environment brings me joy.
      ...
      <section>
        ...
        <p>
          Some of my favorite frontend tools and libraries include TailwindCSS,
          Zod, Tanstack React Query, and React Toastify. These tools help me
          make my projects more efficient and visually appealing.
        </p>
      </section>
      <section>
        <h2>
        ...
        <p>
          ...
          my development journey. I aim to learn new things in every project and
          strive to become a better developer.
        </p>
      </section>
    </article>
  );
